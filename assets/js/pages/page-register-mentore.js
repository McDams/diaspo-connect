  ...
  function init() {
    ...
    FormValidation.attach(form, {
      ...
      if (!registerResult.ok) {
        ...
        submitBtn.textContent = "Créer mon profil mentoré";
      ...
      DCUtils.toast("Profil mentoré créé avec succès ! Bienvenue sur DiaspoConnect.", "success");
      setTimeout(() => { window.location.href = `${window.DC_ROOT}pages/mentore/dashboard.html`; }, 700);
    });
  }
