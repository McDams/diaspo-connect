/**
 * Recherche de logement côté mentoré connecté : mêmes filtres que la page
 * publique, avec favoris et candidature simulée (persistés en mémoire sur
 * le profil mentoré le temps de la session).
 */
(function () {
  let housing, mentee;
  ...
  async function init() {
    ...
    if (!user) return;
    await Layout.mountApp("mentore", "logements", user);
