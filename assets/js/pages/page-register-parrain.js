  ...
  function init() {
    ...
    FormValidation.attach(form, {
      ...
      if (!registerResult.ok) {
        ...
        submitBtn.textContent = "Devenir parrain / marraine";
      ...
      const mentor = {
        ...
        bio: fd.get("bio") || "Nouveau parrain sur la plateforme.",
        maxMentees: 2,
        activeMenteeCount: 0,
      ...
      setTimeout(() => { window.location.href = `${window.DC_ROOT}pages/parrain/dashboard.html`; }, 800);
    });
  }
