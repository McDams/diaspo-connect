(function () {
  async function init() {
    ...
    if (!user) return;
    await Layout.mountApp("parrain", "dashboard", user);
    ...
    document.getElementById("active-mentees-list").innerHTML = activeMatchings.length
      ...
      : `<div class="dc-empty-state py-3"><p class="small mb-0">Aucun filleul actif pour le moment.</p></div>`;
    ...
    document.getElementById("tasks-list").innerHTML = `
      ...
      ${activeMatchings.length ? `<div class="dc-checklist-item"><i class="bi bi-chat-dots text-primary"></i><span class="ms-2 small">Prendre des nouvelles de vos filleuls actifs</span></div>` : ""}
